...
//        if (!StringUtils.startsWithAny(p, new String[]{"/"}) && StringUtils.startsWithAny(path, new String[]{\\", "/"})) {
//            p += "/";
//        }
//        if (!StringUtils.endsWithAny(p, new String[]{"/"}) && StringUtils.endsWithAny(path, "\\", "/")) {
//            p = p + "/";
//        }
//        return p;
//    }
