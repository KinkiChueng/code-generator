...
import com.pengji.linker.gencode.entity.sys.Area;
import com.pengji.linker.gencode.entity.sys.Office;
import com.pengji.linker.gencode.entity.sys.User;
...
public class GenUtils {
    ...
    private static final String DEF_PATH = "d:\\gencode";
    ...
    public static void initColumnField(GenTable genTable) {
        for (GenTableColumn column : genTable.getColumnList()) {
            ...
            // 设置java字段名
            column.setJavaField(toCamelCase(column.getName()));
    ...
    public static <T> T fileToObject(String fileName, Class<?> clazz) {
        ...
        // String pathName = StringUtils.replace(getTemplatePath() + "/" +
    ...
    public static Map<String, Object> getDataModel(GenScheme genScheme) {
        ...
        model.put("functionVersion", new Date());
    ...
    public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile) {
        // 获取生成文件
        String fileName = DEF_PATH + File.separator// Global.getProjectPath() +
                // File.separator
